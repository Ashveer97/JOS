<%@ Page Title="JOS - Property Identity" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PropertyIdentity.aspx.cs" Inherits="SmartProp.PropertyIdentity" %>
            ...
            <div class="page-header-content pt-4">
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        ...
                        <div class="page-header-subtitle">This is where you will see your properties to manage and manage functions.</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <asp:Button runat="server" ID="btnCreate" Text="Create" CssClass="btn btn-primary btn-sm form-control" />
                    </div>
                </div>
